  ...
  "inline-flex items-center rounded-full border px-2.5 py-0.5 text-xs font-semibold transition-smooth focus:outline-none focus:ring-2 focus:ring-ring focus:ring-offset-2",
  {
    variants: {
      variant: {
        ...
        secondary: "border-transparent bg-secondary/90 text-secondary-foreground shadow-soft",
        destructive: "border-transparent bg-destructive/90 text-destructive-foreground shadow-soft",
        outline: "text-foreground border-border/60 bg-background/60",
      },
    },
    defaultVariants: {
      variant: "default",
