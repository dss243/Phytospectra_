...
BEGIN
  INSERT INTO public.profiles (user_id, display_name, farm_name, specialty, bio)
  VALUES (
    NEW.id,
  ...
  user_role := COALESCE((NEW.raw_user_meta_data->>'role')::public.app_role, 'farmer'::public.app_role);
